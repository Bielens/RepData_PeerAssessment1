...
````{r message=FALSE, label=HISTTOTAL}
require('ggplot2')
...
Highest mean activity (`r round(highestactivity,0)` steps on average) is measured in the interval between
